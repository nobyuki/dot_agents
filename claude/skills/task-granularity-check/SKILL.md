...
description: >
  ...
  対象スキル: plan-feature, plan-doc-update, plan-doc-review, jira-ticket, pr-review, verify-review
---
...
|------------|--------------|-------------|
| PLANNING_AND_TICKETING | 計画作成・チケット起票時のタスク分割基準 | plan-feature, plan-doc-update, jira-ticket |
